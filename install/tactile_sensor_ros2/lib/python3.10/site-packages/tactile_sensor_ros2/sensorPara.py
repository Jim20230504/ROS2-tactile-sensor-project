...
class FingerHeatMap:
    def __init__(self, rows: int, cols: int, file_path: str, cap_count: int,
...
# 定义 fingerParams 数据
finger_params = [
    FingerParamTS(2, 62, 8, 7, 1, 1, 0, 4, 2, 0, 22,
                  "通用手指", "TypeA", finger2_power_cap_index),
    FingerParamTS(17, 78, 16, 13, 2, 2, 1, 3, 4, 1, 22,
                  "两指-大包", "TypeB", finger17_power_cap_index),
    FingerParamTS(27, 66, 16, 15, 1, 1, 0, 3, 4, 1, 22,
                  "通用点阵", "TypeB", finger27_power_cap_index),
    FingerParamTS(44, 60, 14, 13, 1, 1, 0, 3, 4, 1, 22,
                  "通用点阵", "TypeB", finger27_power_cap_index),
    FingerParamTS(50, 36, 6, 5, 1, 1, 0, 3, 4, 1, 22,
                  "通用大拇指", "TypeB", finger27_power_cap_index),
    FingerParamTS(54, 36, 6, 5, 1, 1, 0, 3, 4, 1, 22,
                  "通用小拇指", "TypeB", finger27_power_cap_index),
    FingerParamTS(52, 66, 12, 9, 2, 2, 1, 3, 4, 1, 22,
                  "通用中指", "TypeB", finger27_power_cap_index),
]
